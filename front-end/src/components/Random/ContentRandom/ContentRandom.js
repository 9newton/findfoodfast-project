            ...
            return (
                <div className="content-random">
                    ...
                    <div className='col-10 offset-1 col-xl-8 offset-xl-2 col-xxl-6 offset-xxl-3 input'>
                        <Form.Select className='tag-btn text-center' value={input.tag} onChange={e => handleSearch(e, "tag")}>
                    ...
                    <div className='col-10 offset-1 col-xl-8 offset-xl-2 col-xxl-6 offset-xxl-3 mt-1'>
                        <button className="random-btn" onClick={() => setShowResults(true)} >สุ่มร้านอาหาร</button>
                    </div>
                    {!showResults ? <>
                            ...
                            <Row>
                                ...
                                >
                                    <Card className="card-restaurant">
                                        <Link to={`/home/restaurant/${randomFilter?._id}`} target="_blank">
                                            <Card.Body className="card-show-food">
                                                <Row>
                                                    <Col
                                                        ...
                                                        className="show-img"
                                                    >
                                                        <Image className="img-cover-show" src={randomFilter?.coverImg} alt="" />
                                                    </Col>
                                                    ...
                                                    >
                                                        <div className='detail-right'>
                                                            <div className='mb-3 name-right'>
                                                                <span className='h2 font-blue'>{randomFilter?.name}</span>
                                                            </div>
                                                            <p className='text-dark'>
                                                                อาหารที่ขาย : <span className='font-blue'>{randomFilter?.food}</span>
                                                            </p>
                                                            <p className='text-dark'>
                                                                เวลาเปิด - ปิด : <span className='font-blue'> {randomFilter?.timeOpen}-{randomFilter?.timeClose} น.</span>
                                                            </p>
                                                            <p className='text-dark'>
                                                                วันหยุดของร้าน : <span className='font-blue'>{randomFilter?.holiday.map((holiday, indexHoliday) =>
                                                                    randomFilter?.holiday.length - 1 === indexHoliday ? (
                                                            ...
                                                            <p className='text-dark'>
                                                                เรทราคา : <span className='font-blue'>{randomFilter?.ratePrice} บาท</span>
                                                            </p>
                                                            <p className='font-blue'>
                                                                <FaMapMarkerAlt className='text-danger' /> {randomFilter?.alley}
                                                            </p>
                                                            <div className='box-tag'>
                                                                <span>{randomFilter?.tag.map((tag, indexTag) =>
                                                                    randomFilter?.tag.length - 1 === indexTag ? (
