...
const Edit = () => {
  ...
  const checkboxHolidayFunc = (day) => {
    return holiday.includes(day);
  };

  const checkboxDeliveryFunc = (deliveries) => {
    return delivery.includes(deliveries);
  };

  const checkboxTagFunc = (tags) => {
                          ...
                          <div key={`inline-${type}`} className="mb-3">
                            ...
                            <div className="mt-2">
                              <Form.Check
                                ...
                                id={`inline-${type}-1`}
                                value="วันจันทร์"
                                checked={checkboxHolidayFunc("วันจันทร์")}
                              ...
                              <Form.Check
                                ...
                                id={`inline-${type}-1`}
                                value="วันพุธ"
                                checked={checkboxHolidayFunc("วันพุธ")}
                                onChange={(e) => checkboxHoliday(e)}
                              />
                              <Form.Check
                                inline
                                ...
                                id={`inline-${type}-2`}
                                value="วันพฤหัสบดี"
                                checked={checkboxHolidayFunc("วันพฤหัสบดี")}
                                onChange={(e) => checkboxHoliday(e)}
                              />
                              <Form.Check
                                inline
                                ...
                                id={`inline-${type}-1`}
                                value="วันศุกร์"
                                checked={checkboxHolidayFunc("วันศุกร์")}
                                onChange={(e) => checkboxHoliday(e)}
                              />
                              <Form.Check
                                inline
                                ...
                                id={`inline-${type}-2`}
                                value="วันเสาร์"
                                checked={checkboxHolidayFunc("วันเสาร์")}
                                onChange={(e) => checkboxHoliday(e)}
                              />
                              <Form.Check
                                inline
                              ...
                              <Form.Check
                                ...
                                checked={checkboxHolidayFunc(
                                  "ไม่มีวันหยุดที่แน่นอน"
                                )}
                                onChange={(e) => checkboxHoliday(e)}
                              />
                            </div>
                          ...
                          <div key={`inline-${type}`} className="mb-3">
                            ...
                            <div className="mt-2">
                              <Form.Check
                                ...
                                id={`inline-${type}-1`}
                                value="LINEMAN"
                                checked={checkboxDeliveryFunc("LINEMAN")}
                              ...
                              <Form.Check
                                ...
                                id={`inline-${type}-2`}
                                value="GRAB"
                                checked={checkboxDeliveryFunc("GRAB")}
                                onChange={(e) => checkboxDelivery(e)}
                              />
                              <Form.Check
                                inline
                                ...
                                id={`inline-${type}-1`}
                                value="Robinhood"
                                checked={checkboxDeliveryFunc("Robinhood")}
                                onChange={(e) => checkboxDelivery(e)}
                              />
                              <Form.Check
                                inline
                                ...
                                id={`inline-${type}-2`}
                                value="Shopee"
                                checked={checkboxDeliveryFunc("Shopee")}
                                onChange={(e) => checkboxDelivery(e)}
                              />
                              <Form.Check
                                inline
                                ...
                                id={`inline-${type}-1`}
                                value="Foodpanda"
                                checked={checkboxDeliveryFunc("Foodpanda")}
                                onChange={(e) => checkboxDelivery(e)}
                              />
                              <Form.Check
                                inline
                                ...
                                id={`inline-${type}-2`}
                                value="ร้านส่งเอง"
                                checked={checkboxDeliveryFunc("ร้านส่งเอง")}
                                onChange={(e) => checkboxDelivery(e)}
                              />
                              <Form.Check
                                inline
                                ...
                                id={`inline-${type}-1`}
                                value="ไม่มีส่ง"
                                checked={checkboxDeliveryFunc("ไม่มีส่ง")}
                                onChange={(e) => checkboxDelivery(e)}
                              />
                            </div>
                          </div>
                          ...
                          <div key={`inline-${type}`} className="mb-3">
                            ...
                            <div className="mt-2">
                              <Form.Check
                                ...
                                id={`inline-${type}-1`}
                                value="อาหารจานเดียว"
                                checked={checkboxTagFunc("อาหารจานเดียว")}
                              ...
                              <Form.Check
                                ...
                                id={`inline-${type}-2`}
                                value="ก๋วยเตี๋ยว"
                                checked={checkboxTagFunc("ก๋วยเตี๋ยว")}
                                onChange={(e) => checkboxTag(e)}
                              />
                              <Form.Check
                                inline
                              ...
                              <Form.Check
                                ...
                                id={`inline-${type}-2`}
                                value="หมูกะทะ"
                                checked={checkboxTagFunc("หมูกะทะ")}
                                onChange={(e) => checkboxTag(e)}
                              />
                              <Form.Check
                                inline
                              ...
                              <Form.Check
                                ...
                                id={`inline-${type}-2`}
                                value="ของทานเล่น"
                                checked={checkboxTagFunc("ของทานเล่น")}
                                onChange={(e) => checkboxTag(e)}
                              />
                              <Form.Check
                                inline
                                ...
                                id={`inline-${type}-1`}
                                value="ของหวาน"
                                checked={checkboxTagFunc("ของหวาน")}
                                onChange={(e) => checkboxTag(e)}
                              />
                              <Form.Check
                                inline
